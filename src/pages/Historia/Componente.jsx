...
<section>
  <div class="historia-container">
    <div class="texto-guayerd">
      <h2 class="texto-h2">Guayerd Bikes</h2>
      <p class="texto-p"> Bill Jobs
    ...
    <div class="img-guayerd">
    <img alt="image"alt="Bill Jobs andando en bicicleta" class="historia-img" src={Img1} width="500" />
       </div>
  </div>
  <div class="historia-container1">
    <div class="texto-innovacion">
      <h2 class="texto-h2">Innovación</h2>
      <p class="texto-p1">La historia de cada bicicleta GUAYERD empieza sólo a 100km del lugar donde la historia
        de
    ...
    <div class="img-innovacion">
    <img alt="image" alt="La innovación de bicicleta" class="historia-img" src={Img3} width="500" />
    </div>
  </div>
  <div class="historia-container2">
    <div class="texto-bicis">
      <h2 class="texto-h2">Bicis</h2>
      <p class="texto-p">
        GUAYERD Industry
        Co.,Ltd, no sólo mira
    ...
    <div class="img-bicis">
          <img alt="image" alt="fabricación de bicicletas" class="historia-img" src={Img4} width="500" />
    </div>
  </div>
  <div class="historia-container3">

    <div class="texto-exito">
      <h2 class="texto-h2"> Más Éxitos</h2>
      <p class="texto-p1">Durante
    ...
    <div class="img-exito">
          <img alt="image" alt="fabricación de bicicletas" class="historia-img"src={Img2} width="500" />
    </div>
  </div>
</section>
</>
