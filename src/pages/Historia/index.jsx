import Img1 from "../../Image/historia-bici.jpg";
import Img2 from "../../Image/historia-exito.jpg";
import Img3 from "../../Image/historia-innovacion.jpg";
    ...
    <>
        ...
        <section>
            <div className="historia-container">
                <div className="texto-guayerd">
                    <h2 className="texto-h2">Guayerd Bikes</h2>
                    <p className="texto-p"> Bill Jobs
                        (1947-2003) fue el fundador de
                        Guayerd Bikes. Un auténtico visionario que decidió
                ...
                <div className="img-guayerd">
                    <img alt="Bill Jobs andando en bicicleta" className="historia-img" src={Img1} width="500" />
                </div>
            </div>
            <div className="historia-container1">
                <div className="texto-innovacion">
                    <h2 className="texto-h2">Innovación</h2>
                    <p className="texto-p1">La historia de cada bicicleta GUAYERD empieza sólo a 100km del lugar donde la historia
                        de
                ...
                <div className="img-innovacion">
                    <img alt="La innovación de bicicleta" className="historia-img" src={Img3} width="500" />
                </div>
            </div>
            <div className="historia-container2">
                <div className="texto-bicis">
                    <h2 className="texto-h2">Bicis</h2>
                    <p className="texto-p">
                        GUAYERD Industry
                        Co.,Ltd, no sólo mira
                        atrás con su experiencia de 40 años usando
                        ...
                        nadie confía en nuestras bicicletas más que nosotros.</p>
                </div>
                <div className="img-bicis">
                    <img alt="fabricación de bicicletas" className="historia-img" src={Img4} width="500" />
                </div>
            </div>
            <div className="historia-container3">

                <div className="texto-exito">
                    <h2 className="texto-h2"> Más Éxitos</h2>
                    <p className="texto-p1">Durante
                        más de una década, GUAYERD ha sido el principal patrocinador del MULTIVAN
                ...
                <div className="img-exito">
                    <img alt="fabricación de bicicletas" className="historia-img" src={Img2} width="500" />
                </div>
            </div>
        </section>
    </>
